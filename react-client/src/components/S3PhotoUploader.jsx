...
class S3PhotoUploader extends React.Component {
  constructor(props) {
    super(props);
    this.style = {
      width: "25px",
  ...
  handleFinishedUpload(info) {
    ...
    uploadPhoto(this.props.currentUser, info.fileUrl, function(err, data) {
...
export default connect(mapStateToProps)(S3PhotoUploader);
