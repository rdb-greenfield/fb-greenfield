 ...
 *  to create the database and the tables.*/
          ...
          VALUES
            ('Tyler', 'Standley', '$2a$10$vxly/iIX.p5.na707H7Mke/bfYJmx76GScIYWFjcgiiFPiq12Hl1C', 'https://s3-us-west-1.amazonaws.com/greenfield-images/c5b7b371-5563-4d94-bee5-77eacb545ff3_headshot-210.jpg', 'tyler@gmail.com');
          INSERT INTO users
            (firstName, lastName, pw, profilepicture, email)
          VALUES
            ('Mark', 'Khuzam', '$2a$10$vxly/iIX.p5.na707H7Mke/bfYJmx76GScIYWFjcgiiFPiq12Hl1C', 'https://s3-us-west-1.amazonaws.com/greenfield-images/fbad657d-a547-4935-b3e1-7722ec207dd1_34495635.jpeg', 'mark@gmail.com');
          INSERT INTO users
            (firstName, lastName, pw, profilepicture, email)
          VALUES
          ...
          INSERT INTO users
            (firstName, lastName, pw, profilepicture, email)
          VALUES
            ('Derek', 'DeCoste', '$2a$10$WvFS84pvni6NAGZrgwAdGukzBUbK5iAAoz8WNXkFvtjWFUAjfGuaq', 'http://emblemsbattlefield.com/uploads/posts/2014/7/facebook-default-picture_1.jpg', 'derek@gmail.com');
          ...
          INSERT INTO photos
            (owner_id, photo)
          VALUES
            (1, 'https://s3-us-west-1.amazonaws.com/greenfield-images/31ead81b-74d6-4428-98d4-d69f01386b07_headshot-94.jpg');
          INSERT INTO photos
            (owner_id, photo)
          VALUES
            (1, 'https://s3-us-west-1.amazonaws.com/greenfield-images/a5c20337-5648-4a9d-8e63-6d3fc512092b_headshot-207.jpg');
          INSERT INTO photos
            (owner_id, photo)
          VALUES
            (2, 'https://s3-us-west-1.amazonaws.com/greenfield-images/bcd24e60-cc75-4035-9ad3-b0e3a173356c_12-22-17_Awakening_Tommy_Trash_700x368.jpg');
